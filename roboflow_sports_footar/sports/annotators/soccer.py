...
def draw_points_on_pitch(
    config: SoccerPitchConfiguration,
    xy: np.ndarray,
    face_color: sv.Color = sv.Color(255, 0, 0),  # RED
    edge_color: sv.Color = sv.Color(0, 0, 0),  # BLACK
    radius: int = 3,
    thickness: int = 2,
    padding: int = 20,
    scale: float = 0.1,
...
def draw_paths_on_pitch(
    ...
    color: sv.Color = sv.Color(255, 255, 255),  # WHITE
    thickness: int = 2,
    padding: int = 50,
    scale: float = 0.1,
    pitch: Optional[np.ndarray] = None
...
def draw_pitch_voronoi_diagram(
    ...
    team_1_color: sv.Color = sv.Color(255, 0, 0),  # RED
    team_2_color: sv.Color = sv.Color(255, 255, 255),  # WHITE
    opacity: float = 0.5,
    padding: int = 50,
    scale: float = 0.1,
    pitch: Optional[np.ndarray] = None
